...
public class Controlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Obtener el parámetro "menu" de la URL (ej: Controlador?menu=Principal)
        ...
        if (menu != null) {
            switch (menu) {
                ...
                default:
                    // Si el menú no es reconocido
                    response.getWriter().println("Opción no válida: " + menu);
            }
        } else {
            // Si no se recibe el parámetro "menu"
            response.sendRedirect("index.jsp");
        }
    }
